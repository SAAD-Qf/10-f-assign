...
export default function Books() {
  ...
  return (
    <div className="p-[20px] min-h-min w-screen bg-gradient-to-r from-pink-500 to-purple-400 absolute bg-cover">
      <h1 className="text-xl font-serif mb-4 px-4 border-2 rounded-lg shadow-sm text-center justify-center bg-rose-400 text-white">My Books</h1>
        ...
        {books.length > 0 ? (
          books.map((book) => (
            ...
            >
              ...
              />
              <h1 className="mt-4 bg-gradient-to-r from-rose-500 to-pink-400 w-[49%] text-center rounded-lg mx-auto p-3 text-lg md:text-xl">
               {book.title}
              </h1>
